...
const Bookings = () => {
  ...
  useEffect(() => {
    ...
    let newDateArrival = startDateArrival
      .toLocaleDateString()
      .split("/")
      .reverse();
    ...
    let newDateBooking = startDateBooking
      .toLocaleDateString()
      .split("/")
      .reverse();
    ...
    let newDateDeparture = startDateDeparture
      .toLocaleDateString()
      .split("/")
      .reverse();
    ...
    <div className={styles.bookingsOuterContainer}>
      ...
      <div className={styles.bookingsMainContainer}>
        <div className={styles.bookingsSearchSection}>
          <span className={styles.bookingsSearchSectionBookingsMngmtSpan}>
            <Link href={`/crs/${bookingId}`}>
              <BiArrowBack
                className={styles.bookingsSearchSectionBookingsMngmtIcon}
              />
            </Link>
            Booking Management
          </span>
          <span className={styles.bookingsSearchSectionBookingsInputSpan}>
            <BiSearch className={styles.bookingsSearchSectionIcon} size={26} />
            <input
              className={styles.bookingsSearchSectionInput}
        ...
        <div className={styles.bookingsTableSection}>
          ...
          <div className={styles.bookingsTableDropdownsSection}>
            <span
              className={styles.bookingsTableDropdown}
              onMouseLeave={() => {
                setRoomTypeDropdown(false);
              }}
              onClick={() => {
                setRoomTypeDropdown(!roomTypeDropdown);
                setBookingStatusDropdown(false);
                setBookingSourceDropdown(false);
              }}
            >
              <span>
                {roomType.length > 20
                  ? roomType.substr(0, 20) + "..."
                  : roomType}
              </span>
              <AiFillCaretDown />
              <span className={styles.bookingsTableDropdownTopText}>
                Filter By Room Type
              </span>
              {roomTypeDropdown ? (
                <ul>
            ...
            <span
              ...
              onClick={() => {
                setRoomTypeDropdown(false);
                setBookingStatusDropdown(!bookingStatusDropdown);
                setBookingSourceDropdown(false);
              }}
            >
              <span>
                {bookingStatus.length > 20
                  ? bookingStatus.substr(0, 20) + "..."
                  : bookingStatus}
              </span>
              <AiFillCaretDown />
              <span className={styles.bookingsTableDropdownTopText}>
            ...
            <span
              ...
              onClick={() => {
                setRoomTypeDropdown(false);
                setBookingStatusDropdown(false);
                setBookingSourceDropdown(!bookingSourceDropdown);
              }}
            >
              <span>
                {bookingSource.length > 20
                  ? bookingSource.substr(0, 20) + "..."
                  : bookingSource}
              </span>
              <AiFillCaretDown />
              <span className={styles.bookingsTableDropdownTopText}>
              ...
              {bookingSourceDropdown ? (
                <ul>
                  ...
                  <li
                    onClick={() => {
                      setBookingSource("Fit Frequent Individual Traveller");
                    }}
                  >
                  ...
                  <li
                    onClick={() => {
                      setBookingSource("The Hotel Mate");
                    }}
                  >
                    The Hotel Mate
                  </li>
            ...
            <div>
              <DatePicker
                selected={startDateBooking}
                onChange={(date) => setStartDateBooking(date)}
            ...
            <div>
              <DatePicker
                selected={startDateArrival}
                onChange={(date) => setStartDateArrival(date)}
              ...
              ? booking.map((val, i) => {
                  ...
                  if (val.bookings) {
                    return val.bookings.map((val2, j) => {
                      ...
                      return (
                        <>
                          {arrivalDateToShow == val2.$.arrival ||
                          bookingDateToShow ==
                            val2.$.booking_date.slice(0, 10) ||
                          departureDateToShow == val2.$.departure ? (
                            <Row
                              key={j}
                              className={styles.bookingsTableInnerRow}
                            >
                              <Col>
                                <span>
                              ...
                              <Col>
                                <span>{val2.$.booking_id}</span>
                              </Col>
                              <Col>
                                <span>
                                  {val2.customer[0].$.first_name}{" "}
                                  {val2.customer[0].$.last_name}
                                </span>
                              </Col>
                              <Col>
                                <span>{val2.$.booking_date.slice(0, 10)}</span>
                              </Col>
                              <Col>
                                <span>{val2.$.arrival}</span>
                              </Col>
                              <Col>
                                <span>{val2.$.departure}</span>
                              </Col>
                              <Col>
                                <span>{val2.$.room_type}</span>
                              </Col>
                              <Col>
                                <span>Walkin</span>
                              </Col>
                              ...
                              <Col>
                                <span>
                                  {val2.prices[0].$.net_inclusive_amt}
                                </span>
                              </Col>
                              <Col>
                                <span></span>
